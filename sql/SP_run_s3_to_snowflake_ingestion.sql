...
IMPORTS = (
  '@CT_PROTOCOL.LINKML.S3_TO_SF_GIT_REPO/branches/__BRANCH__/ingestion/aws_s3_snf_ingestion.py',
  '@CT_PROTOCOL.LINKML.S3_TO_SF_GIT_REPO/branches/__BRANCH__/config/aact_ingest_config.yaml',
  '@CT_PROTOCOL.LINKML.S3_TO_SF_GIT_REPO/branches/__BRANCH__/config/citeline_ingest_config.yaml'
)
HANDLER = 'main'
EXECUTE AS CALLER
AS
